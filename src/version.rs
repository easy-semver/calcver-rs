...
pub fn get_next_version(config: &config::ProjectConfig, bump_behavior: VersionBumpBehavior, commits: &Vec<String>, last_tag: Option<&str>, release: bool) -> Result<String,error::CalcverError> {
...
fn get_current_version(config: &config::ProjectConfig,last_tag: Option<&str>) -> Result<String,error::CalcverError> {
...
mod tests {
    use super::*;
    fn get_config() -> config::ProjectConfig {
